...
export const TRANSLATIONS = {
  ...
  fa: {
    ...
    aiSettingsTitle: "تنظیمات هوش مصنوعی شیپور",
    aiSettingsSubtitle: "تنظیمات کلید API و مدل هوشمند",
    geminiApiKeyLabel: "کلید دسترسی هوش مصنوعی (API Key)",
    getFreeKey: "دریافت کلید رایگان",
    apiKeyNote: "کلید شما فقط به صورت محلی در مرورگر ذخیره می‌شود و به هیچ سرور شخص ثالثی ارسال نمی‌گردد.",
    modelSelectionLabel: "مدل انتخابی",
    agentPersonaLabel: "لحن و شخصیت دستیار",
    aiSettingsSaved: "تنظیمات هوش مصنوعی با موفقیت ذخیره شد.",
    aiKeyRequired: "لطفاً ابتدا کلید API را وارد کنید.",
    aiConnectedSuccess: "ارتباط با هوش مصنوعی با موفقیت برقرار شد!",
    negotiatorTitle: "دستیار مذاکره و چانه‌زنی قیمت",
    negotiatorSubtitle: "تولید پیام‌های هوشمند و متقاعدکننده برای تخفیف گرفتن از فروشنده",
    selectStrategy: "انتخاب استراتژی مذاکره:",
    messageCopied: "متن پیام در کلیپ‌بورد کپی شد!",
    save: "ذخیره تنظیمات",
  },
  ...
  en: {
    ...
    aiSettingsTitle: "Sheypoor AI Settings",
    aiSettingsSubtitle: "API Key & Intelligent Model Configuration",
    geminiApiKeyLabel: "AI Access Key (API Key)",
    getFreeKey: "Get Free API Key",
    apiKeyNote: "Your key is stored locally in your browser and never shared with third-party servers.",
    modelSelectionLabel: "Selected Model",
    agentPersonaLabel: "Agent Persona",
    aiSettingsSaved: "AI settings saved successfully.",
    aiKeyRequired: "Please enter an API key first.",
    aiConnectedSuccess: "Successfully connected to AI model!",
    negotiatorTitle: "Deal & Price Negotiator",
    negotiatorSubtitle: "Generate persuasive, respectful discount messages for sellers",
    selectStrategy: "Select Negotiation Strategy:",
  ...
  de: {
    ...
    aiSettingsTitle: "Sheypoor KI-Einstellungen",
    aiSettingsSubtitle: "API-Schlüssel & Modellkonfiguration",
    geminiApiKeyLabel: "KI-Zugangsschlüssel (API Key)",
    getFreeKey: "Kostenlosen Schlüssel anfordern",
    apiKeyNote: "Ihr Schlüssel wird nur lokal in Ihrem Browser gespeichert.",
    modelSelectionLabel: "Ausgewähltes Modell",
    agentPersonaLabel: "Assistenten-Persönlichkeit",
    aiSettingsSaved: "KI-Einstellungen erfolgreich gespeichert.",
    aiKeyRequired: "Bitte geben Sie zuerst einen API-Schlüssel ein.",
    aiConnectedSuccess: "Erfolgreich mit dem KI-Modell verbunden!",
    negotiatorTitle: "Preis- & Verhandlungsassistent",
    negotiatorSubtitle: "Erstellen Sie überzeugende Preisangebote für Verkäufer",
    selectStrategy: "Verhandlungsstrategie wählen:",
