...
function ScraperForm() {
  ...
  const submitHandler = (event) => {
    ...
    if (!form.url || !form.categoryId) {
      toast.error("لطفا آدرس دیوار و دسته‌بندی را وارد کنید.");
      return;
    }
    mutate(form);
  };
  ...
  return (
    <div className="w-full flex flex-col md:flex-row mt-12 bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
      ...
      >
        <h3 className="text-xl font-bold text-gray-800 mb-6">اسکرپر دیوار</h3>
        <p className="text-sm text-gray-500 mb-6">آدرس صفحه دسته‌بندی دیوار را وارد کنید تا ۲۰ آگهی آخر اسکرپ شود.</p>
        ...
        <div className="mb-5">
          ...
          <input
            ...
            name="url"
            id="url"
            placeholder="مثال: https://divar.ir/s/tehran/real-estate"
      ...
      <div className="hidden md:flex w-1/2 bg-gray-50 p-8 items-center justify-center border-r border-gray-100">
        <div className="text-center">
          ...
          <p className="text-gray-500 text-sm leading-relaxed max-w-xs mx-auto">
            با وارد کردن لینک دیوار، آخرین آگهی‌های آن دسته به همراه عکس و مشخصات مستقیما وارد سایت شما می‌شود.
          </p>
        </div>
      </div>
    </div>
